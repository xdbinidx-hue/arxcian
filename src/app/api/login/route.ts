...
export async function POST(req: NextRequest) {
  ...
  // uuden rajoituskiintiön. x-real-ip tulee Vercelin proxyltä eikä ole
  // asiakkaan asetettavissa. Next 15 ei enää tarjoa req.ip-kenttää.
  const ip = req.headers.get('x-real-ip') ?? 'tuntematon'
