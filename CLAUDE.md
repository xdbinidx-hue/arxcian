...
11.8.2026 pääteltiin että vika oli bottimaisessa User-Agentissa, ja selainmaiset otsakkeet lisättiin. **Päätelmä oli väärä** — vika jatkui vielä kahdeksan päivää. Selvitys 19.8.2026: kaikki kuusi kanava-ID:tä vastasivat `HTTP 200` kotiverkosta *ilmankin* otsakkeita, samana päivänä kun tuotanto lokitti niille `HTTP 404` ja `HTTP 500`. Klo 08:00 ajo kaatui kokonaan ja klo 20:00 ajo haki kaikki viisi kanavaa. Muuttuja on siis lähettävä IP, ei otsake eikä kanava. Otsakkeet ovat yhä tallella (`CONSENT`-eväste on aidosti tarpeen), mutta ne eivät ole korjaus.
